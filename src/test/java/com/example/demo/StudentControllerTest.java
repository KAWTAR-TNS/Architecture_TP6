...
class StudentControllerTest {
    ...
    void testDeleteStudent() {
        ...
        AssertJUnit.assertEquals(HttpStatus.NO_CONTENT, response.getStatusCode());
    }
    ...
    void testFindAllStudents() {
        ...
        AssertJUnit.assertEquals(2, response.getBody().size());
    ...
    void testFindByYear() {
        ...
        AssertJUnit.assertEquals(0, response.getBody().size());
        AssertJUnit.assertEquals(HttpStatus.OK, response.getStatusCode());
    }
}